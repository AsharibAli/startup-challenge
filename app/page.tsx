...
import { Calendar, Trophy, Users, Sparkles, Star, Zap, MessageCircle, Clock } from "lucide-react"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left space-y-6 sm:space-y-8">
              ...
              <motion.p
                ...
                style={{ fontFamily: "Kalam, cursive" }}
              >
                Transform your innovative ideas into reality. Join the ultimate 4-month startup challenge and compete
                for a <span className="font-bold text-yellow-600">$1000 laptop prize</span>.
              </motion.p>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 font-medium" style={{ fontFamily: "Kalam, cursive" }}>
                    Brand New Laptop
                  </p>
                </div>
                ...
                <div className="text-center bg-purple-50 rounded-2xl p-4">
                  <p className="text-purple-700 font-medium" style={{ fontFamily: "Kalam, cursive" }}>
                    🎯 Personally Sponsored by
                  </p>
                  <p className="text-purple-900 font-bold text-lg" style={{ fontFamily: "Kalam, cursive" }}>
                    Sir Asharib Ali
                  </p>
                </div>
            ...
            <div className="bg-gradient-to-br from-purple-100 via-pink-50 to-orange-100 rounded-3xl p-8 sm:p-12 border-2 border-purple-200 relative overflow-hidden">
              ...
              <div className="absolute inset-0 opacity-10">
                <svg width="100%" height="100%" viewBox="0 0 400 200">
                  <path d="M0,100 Q100,50 200,80 Q300,110 400,90 Q350,140 200,120 Q100,150 0,100 Z" fill="#A855F7" />
                  <path
              ...
              <div className="relative z-10 text-center">
                ...
                {!isTimeUp && (
                  ...
                  >
                    {[
                      ...
                      { label: "Minutes", value: timeLeft.minutes, color: "pink" },
                      { label: "Seconds", value: timeLeft.seconds, color: "orange" },
                    ].map((item, index) => {
                      const colorClasses = {
                        purple: "bg-purple-500 border-purple-300 shadow-purple-200",
                        blue: "bg-blue-500 border-blue-300 shadow-blue-200",
                        pink: "bg-pink-500 border-pink-300 shadow-pink-200",
                        orange: "bg-orange-500 border-orange-300 shadow-orange-200",
                      }
                      ...
                      return (
                        <motion.div
                          ...
                          className={`bg-white rounded-2xl p-4 sm:p-6 lg:p-8 border-2 ${colorClasses[item.color as keyof typeof colorClasses].split(" ")[1]} shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105`}
                        >
                          <div
                            className={`w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 ${colorClasses[item.color as keyof typeof colorClasses].split(" ")[0]} rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-lg`}
                          >
                            <span
                ...
                {isTimeUp && (
                  ...
                  >
                    ...
                    <h3 className="text-3xl font-bold text-gray-900 mb-4" style={{ fontFamily: "Kalam, cursive" }}>
                      Thank You for Participating!
                    </h3>
                    <p className="text-xl text-gray-600" style={{ fontFamily: "Kalam, cursive" }}>
                      All submissions are now being reviewed. The winner will be announced soon!
                    </p>
                  </motion.div>
                )}
                ...
                {!isTimeUp && (
                  ...
                  >
                    <p
                      ...
                      style={{ fontFamily: "Kalam, cursive" }}
                    >
                      🚀 Every second counts! Build, iterate, and make your startup dreams a reality.
                    </p>
                  </motion.div>
                )}
              </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-3 sm:px-4 bg-gradient-to-br from-green-50 to-emerald-50 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="absolute inset-0 opacity-5">
            <svg width="100%" height="100%" viewBox="0 0 400 200">
              <path d="M0,100 Q100,50 200,80 Q300,110 400,90 L400,200 L0,200 Z" fill="#10B981" />
            </svg>
          </div>
          ...
          >
            ...
            >
              <Button
                ...
                style={{ fontFamily: "Kalam, cursive" }}
                onClick={() => window.open("https://whatsapp.com/channel/0029Vb30Egq2Jl8NZ7t3BA0A", "_blank")}
              >
